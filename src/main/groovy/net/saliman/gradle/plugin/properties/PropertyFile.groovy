...
/**
 * Simple little wrapper for a gradle file that has the filename and whether or not the file is
 * required.
 *
...
class PropertyFile {
     ...
     * @param containsSystemProperties whether or not this file can contain properties that should
     *         be converted into System properties.
     */
